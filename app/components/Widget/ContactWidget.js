      ...
      <Hidden xsDown>
        <ListItemSecondaryAction>
          <Tooltip title={props.intl.formatMessage(messages.chat)}>
            <IconButton className={props.classes.blackText} aria-label="Chat">
              <Chat />
            </IconButton>
          </Tooltip>
          <Tooltip title={props.intl.formatMessage(messages.email)}>
            <IconButton className={props.classes.blackText} aria-label="Email">
              <Mail />
            </IconButton>
          </Tooltip>
          <Tooltip title={props.intl.formatMessage(messages.call)}>
            <IconButton className={props.classes.blackText} aria-label="Telp">
              <PhoneIcon />
            </IconButton>
          </Tooltip>
        </ListItemSecondaryAction>
        ...
        <AppBar position="static" color="default">
          ...
          <Hidden smDown>
            ...
            >
              ...
              <Tab label={intl.formatMessage(messages.massages)} icon={<Chat />} />
              <Tab label={intl.formatMessage(messages.contacts)} icon={<NotificationsActive />} />
            </Tabs>
          </Hidden>
        </AppBar>
